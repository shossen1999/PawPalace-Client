...
const UpdateCampaign = () => {
    const { _id, petName, maxDonationAmount, lastDate, shortDescription, longDescription } = useLoaderData()
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (imgbbResponse.data.success) {
                ...
                await axiosSecure.patch(`/updateDonation-camp/${_id}`, campaignData);
                Swal.fire({
                    title: "Success!",
        ...
        <div className="max-w-lg mx-auto p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="mb-4">
                    ...
                    {...register("petName", { required: true })} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter Pet name" />
                ...
                <div className="mb-4">
                    ...
                    <input id="maxDonation" type="number"
                    defaultValue={maxDonationAmount}
                    {...register("maxDonationAmount", { required: true })} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter maximum donation amount" />
                ...
                <div className="mb-4">
                    ...
                    {...register("lastDate", { required: true })} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                ...
                <div className="mb-4">
                    ...
                    {...register("shortDescription", { required: true })} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter short description" />
                ...
                <div className="mb-6">
                    ...
                    {...register("longDescription", { required: true })} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter long description" rows="4"></textarea>
